...
//   return (
//     <div className="bg-white flex flex-wrap mt-2">
//       {/* Headlines label */}
...
const BreakingLine = ({ news }) => {
  const newsArray = Array.isArray(news) ? news : []; // Ensure we have an array
        ...
        <div className="flex w-full justify-start items-center overflow-hidden whitespace-nowrap">
          <Marquee gradient={false} pauseOnHover={true} speed={60}>
            {newsArray.length > 0 ? (
              ...
              <span className="text-gray-500 px-4">No news available</span>
            )}
          </Marquee>
        </div>
      </div>
